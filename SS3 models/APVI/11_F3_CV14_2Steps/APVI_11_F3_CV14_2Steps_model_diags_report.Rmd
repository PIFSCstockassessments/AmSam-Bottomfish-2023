...
```{r fig.align='center', out.width='.49\\linewidth', message=FALSE}
...
sspar(mfrow = c(1,2))
SSplotRunstest(report., subplots = "len", add = TRUE, indexselect = 1, miny = .4)
SSplotJABBAres(report., subplots = "len", add = TRUE, indexselect = 1, miny = .4, ylimAdj = .8)
```
