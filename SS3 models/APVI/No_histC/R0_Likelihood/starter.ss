...
#C file write time: 2022-06-17 12:27:18
data.ss
control.ss
...
1969 # min yr for sdreport outputs (-1 for styr); #_1986
-2 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2022
...
123 # random number seed for bootstrap data (-1 to use long(time) as seed): # 123
