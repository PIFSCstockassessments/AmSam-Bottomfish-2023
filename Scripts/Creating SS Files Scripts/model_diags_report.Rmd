...
# if(report.$nfleets > 1){
#   sspar(mfrow = c(1,1))
#   SSplotJABBAres(report., subplots = "cpue", indexselect = 2, add = TRUE)
# }
```
...
if(dir.exists(file.path(params$report, params$species, params$file_dir, "jitter"))){
  ...
  SSplotComparisons(jittersum, subplots = c(2), plot = TRUE)
