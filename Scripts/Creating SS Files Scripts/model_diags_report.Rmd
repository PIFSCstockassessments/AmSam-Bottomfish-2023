...
report. <- SS_output(dir = file.path(params$report, params$species, params$scenario), verbose = FALSE, printstats = FALSE)
...
### Retrospective 
```{r message=FALSE}
if(dir.exists(file.path("..", "..", "SS3 models", params$species, "Retrospectives"))){
...
```{r }
if(dir.exists(file.path("..", "..", "SS3 models", params$species, "R0_Likelihood"))){
