...
```{r}
#| label: fig-retro
#| fig-cap: "R Retrospective analysis of spawning biomass (left) and fishing mortality (right) consisting of 5 reruns of the base case model each fitted with one less year of data from the base case model (blue line)."
#| out-width: 11.7cm
#| fig-align: center
