...
Lt[[7]]<-list("PRFL", "OMalley_Then",    "OMalley",         "Kamikawa",    "SW_BIOS_BIOS",    F, c(0.5,1.5), 0.29,    T, list(c(2004,2005),c(2011,2012),c(2018,2020)),c(0.5,1.5,0.1)) 
...
#parLapply(cl,Lt,function(x){ # Run all models
  ...
  if(Create_species_report_figs){
    ...
    file.copy(from = file.path(root_dir,"Scripts","03_Report scripts",
