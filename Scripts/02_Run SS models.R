...
Lt[[3]]<-list("CALU", "Fry_Then",        "SW_DIV",          "Kamikawa",    "SW_DIV",   F, c(1.3,2.1), 0.29,    T, list(c(2009,2011),c(2016,2017),c(2018,2020)), c(1,3.4,0.2)) 
...
Lt[[6]]<-list("LUKA", "Loubens_Then",    "Loubens2",        "Kamikawa",    "SW_BBS",   T, c(5.4,7.0), 0.23,    F, NA,                                           c(20,35,1)) 
Lt[[7]]<-list("PRFL", "OMalley_Then",    "OMalley",         "Kamikawa",    "Brouard",  F, c(0.5,1.5), 0.29,    T, list(c(2004,2005),c(2011,2012),c(2018,2020)), c(0.5,1.5,0.1)) 
...
Lt[[9]]<-list("VALO", "Grandcourt_Then", "Schemmel",        "Kamikawa",    "Schemmel", F, c(1.0,2.4), 0.33,    T, list(c(2016,2020)),                           c(0.5,3.0,0.2)) 
