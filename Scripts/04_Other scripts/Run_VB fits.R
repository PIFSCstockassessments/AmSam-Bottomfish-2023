...
R2 <- nlm(VB2_Fit,p=c(80,0.15,-5,16,5,0.1),BreakAge=BreakAge,x=D)
...
ggplot()+geom_point(data=D,aes(x=AGE,y=LENGTH_FL))+geom_line(data=E,aes(x=AGE,y=LENGTH_FL),col="red",size=1)+
